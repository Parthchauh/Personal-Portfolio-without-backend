...
import FlipWords from "./ui/flip-words"; // Adjust import path as needed

const Home = () => {
  const words = ["Learning","Trying","Exploring","implementing","Experimenting"];
      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            I have &lt; 1 years of experience building websites and designing software.
            I love to work on web applications using technologies like
            React, Tailwind, Next.js, and Express.js currently.
          </p>
